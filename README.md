...
# ⚠️ 빈 레포도 OK — 자동으로 Initial Commit을 생성하고 origin remote를 설정합니다.
...
cli:
  ...
  timeouts:
    claude: 900000         # Claude 15분 (thinking 100% 대응)
    gemini: 600000         # Gemini 10분
    codex: 900000          # Codex 15분 (xhigh 대응)
  max_turns:
...
# 인터랙션 모드 지정
node src/index.js run "채팅 기능" --mode full-auto   # 기본값
node src/index.js run "채팅 기능" --mode semi-auto   # Phase마다 확인
node src/index.js run "채팅 기능" --mode manual      # 수동 제어
```
