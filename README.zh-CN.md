...
| 尹悦然 | UX/Visual Designer | Gemini 3.1 Pro | Nano Banana 2 / GPT Image 1.5 |
| 画灵秀 | Illustrator | Gemini 3.1 Pro | Nano Banana 2 / GPT Image 1.5 |
...
OPENAI_API_KEY=sk-...          # OpenAI API（GPT Image 1.5 透明PNG生成）
```
